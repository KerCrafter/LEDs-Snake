project_new -family "Cyclone IV E" -overwrite LEDs-snake-with-joystick
set_global_assignment -name DEVICE EP4CE22F17C6

set_global_assignment -name TOP_LEVEL_ENTITY DE0_NANO_LEDs_snake_with_joystick

set_global_assignment -name PROJECT_OUTPUT_DIRECTORY output_files_with_joystick

set_global_assignment -name VERILOG_FILE src/devices_entry/DE0_NANO_LEDs_snake_with_joystick.v
...
set_global_assignment -name VERILOG_FILE src/joystick_8_directions/src/joystick_8_directions.v
